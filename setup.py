...
def get_version_add(sha: Optional[str] = None) -> str:
    ...
    hcu_version = f"0.18.1+{version}"
    new_version_content = f"""# SPDX-License-Identifier: Apache-2.0
# Generated by setup.py for the platform wheel. Do not edit.

__version__ = "0.18.1"
__version_tuple__ = (0, 18, 1)
__hcu_version__ = "{hcu_version}"
"""
