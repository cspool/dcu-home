...
def prefill(**kwargs):
    ...
    page784_batch = cache_size == 784 and 3 <= num_sequences <= 5
    wide = (cache_size, num_sequences, query.shape[0] >= 128) == (784, 1, True)
    block_m = 32 if page784_batch else (64 if wide else 16)
    ...
    if page784_batch or query.shape[0] >= 128:
    ...
    _gqa6[(triton.cdiv(kwargs["max_seqlen_q"], block_m // 2), 12, num_sequences)](
